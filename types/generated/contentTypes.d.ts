...
export interface ApiBecomeVolunteerBecomeVolunteer extends Schema.SingleType {
  collectionName: 'become_volunteers';
  info: {
    singularName: 'become-volunteer';
    pluralName: 'become-volunteers';
    displayName: 'Become volunteer';
    description: '';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Attribute.Relation<
      'api::become-volunteer.become-volunteer',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiCoreServiceCoreService extends Schema.CollectionType {
  ...
  attributes: {
    ...
    services: Attribute.Component<'items.services', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiDailyUpdateDailyUpdate extends Schema.CollectionType {
  collectionName: 'daily_updates';
  info: {
    singularName: 'daily-update';
    pluralName: 'daily-updates';
    displayName: 'DailyUpdate';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    title: Attribute.String;
    subtitle: Attribute.String;
    updateTitle: Attribute.Component<'item.update', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::daily-update.daily-update',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiFundraisingActionFundraisingAction
  ...
  info: {
    singularName: 'fundraising-action';
    pluralName: 'fundraising-actions';
    displayName: 'FundraisingAction';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::fundraising-action.fundraising-action',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiHelpActionHelpAction extends Schema.CollectionType {
  collectionName: 'help_actions';
  info: {
...
export interface ApiIntroBannerIntroBanner extends Schema.CollectionType {
  collectionName: 'intro_banners';
  info: {
    singularName: 'intro-banner';
    pluralName: 'intro-banners';
    displayName: 'IntroBanner';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiMediaLinkMediaLink extends Schema.CollectionType {
...
export interface ApiNavbarNavbar extends Schema.CollectionType {
  ...
  attributes: {
    ...
    link: Attribute.String;
    order: Attribute.Integer;
    submenus: Attribute.Component<'menu.link', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiOurProgramOurProgram extends Schema.CollectionType {
  collectionName: 'our_programs';
  info: {
    singularName: 'our-program';
    pluralName: 'our-programs';
    displayName: 'Our Program';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    cardSubtitle: Attribute.RichText;
    cardLink: Attribute.String;
...
export interface ApiTrusteeTrustee extends Schema.SingleType {
...
export interface ApiVolunteerBannerVolunteerBanner extends Schema.SingleType {
  collectionName: 'volunteer_banners';
  info: {
    singularName: 'volunteer-banner';
    pluralName: 'volunteer-banners';
    displayName: 'banner';
    description: '';
  };
  options: {
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::volunteer-banner.volunteer-banner',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::intro-banner.intro-banner': ApiIntroBannerIntroBanner;
